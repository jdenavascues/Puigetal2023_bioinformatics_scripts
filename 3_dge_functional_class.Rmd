---
title: "III. Functional classification of differentially expressed genes"
...
targets <- readRDS(file.path('output', 'targets.RDS'))
# DEG data
...
if ( !file.exists(file.path('output', 'scOE_gse_glad.RDS')) ) {
  ...
  saveRDS(scOE_gse_glad, file.path('output', 'scOE_gse_glad.RDS'))
} else scOE_gse_glad <- readRDS(file.path('output', 'scOE_gse_glad.RDS'))
```
