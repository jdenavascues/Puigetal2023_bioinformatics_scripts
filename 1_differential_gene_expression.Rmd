...
### 1.3.1 Download the count data

The datasets are available in GEO. We can simply get a list of download URLs like this:
```{r get-counts-geo}
dirpath <- file.path(getwd(), 'input')
if (!dir.exists( dirpath )) dir.create( dirpath )
download.file('https://www.ncbi.nlm.nih.gov/geo/download/?acc=GSE234019&format=file',
              destfile = file.path(dirpath, 'featureCounts.tar'))
untar(file.path(dirpath, 'featureCounts.tar'))
